...
def main(args, raise_on_errors=False):
    ...
    # load_dataset_kwargs = {
    #     "path": "/data0/maqi/KGLQA-data/datasets/zero_scrolls_datasets",
    #     "name": dataset_name,
    # }
    ...
    seq2seq_dataset=datasets.load_from_disk(f"/data0/maqi/KGLQA-data/datasets/zero_scrolls_datasets/{dataset_name}")
    seq2seq_dataset=seq2seq_dataset['test']
